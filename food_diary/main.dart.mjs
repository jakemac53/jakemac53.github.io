...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _2232: x0 => x0.close(),
      _2233: () => new AbortController(),
      _2234: x0 => x0.abort(),
      _2235: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _2236: (x0,x1) => globalThis.fetch(x0,x1),
      _2237: (x0,x1) => x0.get(x1),
      _2238: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._2238(f,arguments.length,x0,x1,x2) }),
      _2239: (x0,x1) => x0.forEach(x1),
      _2240: x0 => x0.getReader(),
      _2241: x0 => x0.cancel(),
      _2242: x0 => x0.read(),
      _2243: (x0,x1) => x0.item(x1),
      _2247: () => new FileReader(),
      _2248: (x0,x1) => x0.readAsArrayBuffer(x1),
